...
.analyzing_status_divs {
    background-color: #fff;
    border-color: -moz-use-text-color #f6bb42 #f6bb42;
    border-image: none;
...
<div class="analyzing_status">
            <h3>Common SEO issues</h3>
            <div class="analyzing_status_divs">
...
$html2 = '<TABLE>
<tr>	 <td style="height:232px;">
                     <img src="http://pagetest.dev/assets/front/img/grade_a.jpg" alt="Google" width="232px" height="180px" style="border:2px solid silver">
                
				</td>
            </tr>
</TABLE>';
$pdf->writeHTMLCell(0,0, '', '', $html, 0, 1, true, true, '', true);
//$pdf->writeHTMLCell(0,0, '140', '30', $html2, 0, 1, 0, true, '', true);
//$pdf->writeHTML($html, true, 0, true, 0);
//$pdf->MultiCell(100, 5, $html, 1, 'L', 1, 0, '', '', true,'',true);
...
$pdf->Output('example_02121.pdf', 'I');
