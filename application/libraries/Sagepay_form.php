...
//echo $strPost; exit;
    ...
    function _encode_crypt($strIn = NULL) {

        $string = "";
        $this->qryStr = $string = $this->pkcs5_pad($strIn, 16);

        // Perform encryption with PHP's MCRYPT module.
        $crypt = mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->encryption_password, $string, MCRYPT_MODE_CBC, $this->encryption_password);

        // Perform hex encoding and return.
        return "@" . strtoupper(bin2hex($crypt));

//        $crypt = mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->encryption_password, $post, MCRYPT_MODE_CBC, $this->encryption_password);
//        return $crypt;
    ...
    public function decodeAndDecrypt($strIn) {
        ...
        $strInitVector = $this->encryption_password;
        ...
        $strIn = pack('H*', trim($hex));

        // Perform decryption with PHP's MCRYPT module.
        $string = mcrypt_decrypt(MCRYPT_RIJNDAEL_128, $this->encryption_password, $strIn, MCRYPT_MODE_CBC, $this->encryption_password);
    ...
    protected function pkcs5_pad($input, $blocksize) {
        $blockSize = $blocksize;
        $padd = "";
